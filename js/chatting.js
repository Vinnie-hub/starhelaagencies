(function () {
  ...
  const advisors = [
    ...
    },
    {
      ...
      handle: "@Emmili",
      bio: "Quiet, but not boring. I like when words feel like warm light. Genuine conversations, meaningful connection — no empty talk here.",
      status: "available",
      color: "#db2777",
      tags: ["Companion", "Chat"],
      price: "1.99",
    ...
    },
    {
      ...
      bio: "Natural born psychic. I read through date of birth and name, with spirit guides. Honest and very straightforward — no sugarcoating.",
      status: "live",
      color: "#0f766e",
    ...
    },
    {
      ...
      bio: "Top advisor from KEEN. Intuitive and compassionate psychic with 10+ years experience and 32,000+ readings. Over 7,800 reviews.",
      status: "offline",
      color: "#b45309",
    ...
    },
    {
      name: "Morine N",
      handle: "@Moryn97",
      bio: "A safe space for deep talks, personal growth, positive energy and genuine connection. Lonely, overthinking, or chasing goals — I'm here.",
      status: "live",
      color: "#9333ea",
    ...
    },
    {
      ...
      bio: "I guide people through deep personal change — process emotions, find clarity, and feel grounded. Judgment-free calm space.",
      status: "online",
      color: "#065f46",
    ...
    },
    {
      name: "EllisGrace",
      handle: "@EllisGrace",
      bio: "Tarot reader, Energy Healer, Spiritual Coach, and Hypnotherapist — blending modalities to navigate life's deepest questions.",
      status: "online",
      color: "#be185d",
    ...
    },
    {
      ...
      bio: "Luciana ofrece guía psíquica, visión clarividente y lecturas de tarot. Claridad, confianza y conexión con tu alma.",
      status: "available",
      color: "#7e22ce",
      tags: ["Tarot", "Psychic"],
      price: "2.00",
    ...
    },
    {
      name: "Sister Moon",
      handle: "@SisterMoon",
      bio: "Advisor specialist in love and relationships. Third generation God gifted, also a life coach guiding career, family, and finances.",
      status: "available",
      color: "#c2410c",
    ...
    },
    {
      name: "Ankh Marie",
      handle: "@AnkhMarie",
      bio: "Come chat and make friends! I love video games, movies, horror stuff. Always up for real, fun conversation — no fake vibes.",
      status: "live",
      color: "#be185d",
      tags: ["Companion", "Chat", "Video"],
      price: "2.00",
    ...
    },
    {
      name: "Brandy Wolfe",
      handle: "@BrandyWolfe",
      bio: "Shadow Relationship & Spiritual Advisor. Certified Angel Guide & Tarot Reader with 30+ years. Unapologetic, honest, accurate.",
      status: "available",
      color: "#c2410c",
    ...
    },
    {
      name: "Celeste Moon",
      handle: "@CelesteMoon",
      bio: "Vedic astrologer with 18 years of practice. I map your birth chart to reveal your soul's true path — love, career, and destiny.",
      status: "online",
      color: "#4f46e5",
    ...
    },
    {
      ...
      handle: "@OracleRose",
      bio: "Deeply empathic oracle reader. My cards don't just tell — they heal. Specializing in grief, transitions, and spiritual awakening.",
      status: "live",
      color: "#be185d",
    ...
    },
    {
      name: "Marco Vitale",
      handle: "@MarcoV",
      bio: "Certified NLP coach and former therapist. I help high-achievers break invisible blocks. No woo — just results-driven mindset work.",
      status: "online",
      color: "#1e40af",
    ...
    },
    {
      name: "Isabelle Faye",
      handle: "@IsabelleFaye",
      bio: "French intuitive — love readings, twin flames, karmic cycles. I speak plainly about what the cards show, however hard the truth.",
      status: "available",
      color: "#be185d",
    ...
    },
    {
      name: "Dr. Kofi Asante",
      handle: "@DrKofi",
      bio: "Clinical psychologist offering psychoeducation, coping strategies, and a judgment-free space. Not therapy — real knowledge.",
      status: "online",
      color: "#1e3a5f",
    ...
    },
    {
      name: "Coach Reina",
      handle: "@CoachReina",
      bio: "Divorce recovery and life transition coach. I help you move from broken to whole — with compassion, strategy, and fire.",
      status: "online",
      color: "#dc2626",
    ...
    },
    {
      name: "Sunny Side Jen",
      handle: "@SunnySideJen",
      bio: "Positive energy, authentic vibes, real talk. Whether you need motivation or just a warm conversation — I've got time for you.",
      status: "live",
      color: "#d97706",
    ...
    },
    {
      name: "Cleo Vane",
      handle: "@CleoVane",
      bio: "Clairvoyant and dream interpreter. I see what others miss — energy blocks, hidden rivals, and upcoming shifts in your love life.",
      status: "live",
      color: "#9333ea",
    ...
    },
    {
      name: "Madam Zuri",
      handle: "@MadamZuri",
      bio: "Third-generation spiritual advisor from East Africa. Specializing in love, money attraction, and clearing negative energy.",
      status: "available",
      color: "#7e22ce",
    ...
    },
    {
      name: "Hope Mensah",
      handle: "@HopeMensah",
      bio: "Compassionate listener and life guide. No judgment — just a warm, safe space to process and move forward with clarity.",
      status: "live",
      color: "#db2777",
      tags: ["Chat", "Support", "Growth"],
      price: "1.80",
    ...
    },
    {
      name: "Tunde Vision",
      handle: "@TundeVision",
      bio: "Prophetic readings with pinpoint accuracy. Past, present, future. No cold reading — just pure spiritual sight from Lagos.",
      status: "online",
      color: "#0e7490",
    ...
    },
    {
      name: "Elder Chukwu",
      handle: "@ElderChukwu",
      bio: "Traditional diviner and counselor with 40 years of practice. Rooted in Igbo spiritual tradition — love, protection, and guidance.",
      status: "available",
      color: "#78350f",
    ...
    },
    {
      name: "Sister Golda",
      handle: "@SisterGolda",
      bio: "Intercessor and spiritual advisor. Helping people break generational curses, receive divine direction, and walk in purpose.",
      status: "live",
      color: "#b45309",
    ...
    },
    {
      name: "Kwame Fire",
      handle: "@KwameFire",
      bio: "Business coach and entrepreneur from Accra. Start, grow, or pivot — I give real strategy without sugarcoating the hard truths.",
      status: "online",
      color: "#065f46",
    ...
    },
    {
      name: "Mama Efua",
      handle: "@MamaEfua",
      bio: "Traditional spiritual mother and advisor. Combining herbal knowledge, prayer, and energy work for healing and breakthrough.",
      status: "live",
      color: "#78350f",
    ...
    },
    {
      name: "Nadia Bliss",
      handle: "@NadiaBliss",
      bio: "Your online bestie for vent sessions, love advice, and daily motivation. Warm, fun, real — exactly what you need right now.",
      status: "live",
      color: "#ec4899",
      tags: ["Companion", "Chat", "Support"],
      price: "1.40",
    ...
    },
    {
      ...
      bio: "Friendly, warm, and here to listen. Whether you're lonely, overwhelmed, or just want a real chat — I'm here for you.",
      status: "available",
      color: "#db2777",
    ...
    },
    {
      ...
      bio: "Cameroonian spiritual advisor with powerful gift of sight. Love clarity, enemy detection, and future revelation with precision.",
      status: "online",
      color: "#7e22ce",
      tags: ["Psychic", "Spiritual", "Love"],
      price: "3.00",
    ...
    },
    {
      name: "Auntie Dupe",
      handle: "@AuntieDupe",
      bio: "Like your favorite wise auntie — warm, honest, and unfiltered. Relationship advice, life guidance, and real talk from someone who cares.",
      status: "available",
      color: "#b45309",
    ...
    },
    {
      name: "Prophet Dare",
      handle: "@ProphetDare",
      bio: "End-time prophet and spiritual advisor. Deep visions on relationships, career turning points, and spiritual warfare affecting your life.",
      status: "live",
      color: "#b91c1c",
      tags: ["Psychic", "Spiritual", "Career"],
      price: "3.80",
    ...
    },
    {
      name: "Chinyere Calm",
      handle: "@ChinyereCalm",
      bio: "Mental wellness advocate and empathetic listener. Creating calm in the chaos — grief, anxiety, overthinking, and overwhelm welcome.",
      status: "online",
      color: "#0f766e",
      tags: ["Support", "Chat", "Wellness"],
      price: "1.80",
    ...
    },
    {
      name: "Mentor Bayo",
      handle: "@MentorBayo",
      bio: "Business mentor and startup advisor from Lagos. Connecting ideas to execution. Real talk for entrepreneurs at every stage.",
      status: "available",
      color: "#1e40af",
    ...
    },
    {
      name: "Queen Nkechi",
      handle: "@QueenNkechi",
      bio: "Bold empowerment coach for women ready to stop shrinking. Confidence, boundaries, and fierce self-love — your era starts now.",
      status: "online",
      color: "#dc2626",
      tags: ["Coach", "Mindset", "Growth"],
      price: "3.00",
    ...
    },
    {
      ...
      bio: "No-filter psychic advisor from Onitsha. I tell you what you need to hear, not what you want to hear. Love, money, enemies.",
      status: "live",
      color: "#0e7490",
      tags: ["Psychic", "Love", "Finance"],
      price: "3.40",
    ...
    },
    {
      name: "Mama Bisi",
      handle: "@MamaBisi",
      bio: "Yoruba spiritual mother and traditional advisor. Combining Ifa wisdom and heartfelt prayer for love, children, and abundance.",
      status: "live",
      color: "#78350f",
      tags: ["Spiritual", "Love", "Healing"],
      price: "3.60",
    ...
    },
    {
      name: "Abigail Peace",
      handle: "@AbigailPeace",
      bio: "Calming presence for those in emotional turmoil. Let's work through fear, grief, confusion, and self-doubt — one step at a time.",
      status: "live",
      color: "#065f46",
    ...
    },
    {
      name: "Ruqayyah Sees",
      handle: "@RuqayyahSees",
      bio: "Muslim spiritual advisor blending Islamic wisdom and intuitive reading. Istikhara guidance, marriage decisions, and life direction.",
      status: "available",
      color: "#0f766e",
      tags: ["Spiritual", "Love", "Family"],
      price: "2.80",
    ...
    },
    {
      ...
      bio: "Like talking to your wisest relative. Love, family, money, life choices — all welcome here. Real wisdom from lived experience.",
      status: "online",
      color: "#b45309",
    ...
    },
    {
      name: "Emeka Calm",
      handle: "@EmekCalm",
      bio: "Mental wellness guide for men. A safe, masculine space to process stress, relationship pain, and life pressure — no judgment.",
      status: "available",
      color: "#1e40af",
  ...
  function renderCards() {
    let data = visibleAdvisors.filter((a) => {
      ...
      const mC =
        currentCat === "all" ||
        a.tags.some((t) => t.toLowerCase() === currentCat.toLowerCase());
      const mQ =
        !currentSearch ||
    ...
    data.forEach((a) => {
      ...
      div.innerHTML =
        ...
        "</div>" +
        (a.credit
          ? '<div class="credit-banner">🎁 ' + esc(a.credit) + "</div>"
          : "") +
        '<div class="card-body">' +
        '<p class="card-bio">' +
        esc(a.bio) +
        ...
        esc(a.price) +
        "</strong>/min</div>" +
        '<div class="card-rating"><span class="star" aria-hidden="true">★</span><span class="sr-only">Rating</span> ' +
        esc(String(a.rating)) +
        " (" +
  ...
  function updateCounts() {
    ...
    ["all", "live", "online", "available", "offline"].forEach((k) => {
      document.querySelectorAll(".count-" + k).forEach((el) => {
        el.textContent = c[k];
      });
    });
  ...
  const statusDefs = [
    { val: "all", label: "All advisors", dot: "" },
    {
      val: "live",
      label: "Live now",
      dot: '<span class="filter-dot red" aria-hidden="true"></span>',
    },
    {
      val: "online",
      label: "Online",
      dot: '<span class="filter-dot" aria-hidden="true"></span>',
    },
    {
      val: "available",
      label: "Available",
      dot: '<span class="filter-dot blue" aria-hidden="true"></span>',
    },
    {
      val: "offline",
      label: "Offline",
      dot: '<span class="filter-dot offline" aria-hidden="true"></span>',
    },
  ];
  const typeDefs = [
    { val: "all", label: "All" },
  ...
  if (typeChipsEl) {
    typeChipsEl.innerHTML = typeDefs
      .map(
        (t, i) =>
          '<button class="chip' +
          (i === 0 ? " active" : "") +
  ...
  function showModal(a) {
    ...
    if (av) {
      av.textContent = getInitials(a.name);
