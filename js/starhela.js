/* ═══════════════════════════════════════════
   ...
   ═══════════════════════════════════════════ */
      ...
      (function () {
        ...
        const WA_COMMUNITY =
          "https://chat.whatsapp.com/Ir5lbHCr9rPCLuvVzvHAyD";
        ...
        function initOfferwall() {
          ...
          window.openOfferwall = function () {
            ...
            if (!offerwallOpened) {
              ...
              if (typeof window.detectCountry === "function")
                window.detectCountry();
        ...
        function initDisclaimer() {
          ...
          window.showDisclaimer = function () {
            if (sessionStorage.getItem("sh-disclaimer-seen")) {
          ...
          document
            .querySelectorAll(".open-offerwall, .dp-btn-primary")
            .forEach(function (btn) {
              btn.addEventListener("click", function (e) {
                e.preventDefault();
                window.hideDisclaimerAndProceed();
              });
            });
        ...
        function init() {
          ...
          document.addEventListener("keydown", function (e) {
            ...
            if (typeof window.closeOfferwall === "function")
              window.closeOfferwall();
            if (typeof window.hideDisclaimer === "function")
